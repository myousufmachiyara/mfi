...
Route::middleware(['checkPermission: add'])->group(function () {
    ...
    Route::get('/user-role/edit-role/{id}', [App\Http\Controllers\UserRoleController::class, 'edit'])->name('edit-role');
    Route::post('/user-role/update-role', [App\Http\Controllers\UserRoleController::class, 'update'])->name('update-role');
