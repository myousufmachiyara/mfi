<?php
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('/rep-godown-by-item-name/bal/report', [App\Http\Controllers\RptGoDownItemNameController::class, 'tstockbaltReport'])->name('bal-rep-godown-by-item-name-report');
