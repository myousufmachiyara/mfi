...
class RptAccNamePur1Controller extends Controller
{
    //
    ...
    public function purchase1PDF(Request $request)
    {
        ...
        ->select('pur_by_account.*', 'ac.ac_name', 'ac.remarks as ac_remarks') 
        ->orderBy('date', 'asc')
        ->get();
            ...
            $html = '<table border="1" style="border-collapse: collapse;text-align:center">
                        <tr>
                            ...
                            <th style="width:10%;color:#17365D;font-weight:bold;">Name Of Person</th>
