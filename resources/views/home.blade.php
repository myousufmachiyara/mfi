									...
									<div class="row form-group pb-3">
										...
										<div class="mb-3 text-end">
											<div class="form-group d-inline-block">
												<label for="filterHR" class="visually-hidden">Select Month</label>
												<input type="month" class="form-control" id="filterHR" value="{{ date('Y-m') }}" onchange="getTabData()">
											</div>
											<button class="btn btn-primary" style="padding: 0.5rem 0.6rem;" onclick="getTabData()" aria-label="Filter by month">
