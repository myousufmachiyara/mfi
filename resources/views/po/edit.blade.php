									...
									<div class="card-body">
										<div class="row form-group mb-2">
											...
											<div class="col-6 col-md-2 mb-2">
												...
												<input type="text" placeholder="Qoutation No." name="pur_bill_no"  value="{{$pur->pur_bill_no}}" class="form-control">
											</div>
											<div class="col-6 col-md-2 mb-2">
												<label class="col-form-label" >Purchase Inv.</label>
												<input type="text" placeholder="Purchase Inv." name="pur_sale_inv" value="{{$pur->sale_against}}" class="form-control">
											</div>
										...
										<table class="table table-bordered table-striped mb-0" id="myTable" >
											...
											<tbody id="Purchase1Table">
												...
												<tr>
													...
													<td>
														<input type="text" class="form-control" name="pur_qty2[]" id="pur_qty2_{{$pur1_key+1}}" value="{{$pur_items->pur_qty2}}" required>
													</td>
													<td>
                                                    ...
                                                    <td>
														<input type="number" class="form-control" name="pur_qty[]" id="pur_qty{{$pur1_key+1}}"  onchange="rowTotal({{$pur1_key+1}})" step="any" value="{{$pur_items->pur_qty}}" required>
                                                    </td>
													<td>
														<input type="number" class="form-control" name="pur_price[]" id="pur_price{{$pur1_key+1}}" value="{{$pur_items->pur_price}}"  step="any" onchange="rowTotal({{$pur1_key+1}})" value="0" required>
													</td>
													<td>
...
<script>
	...
	function addNewRow(){
		...
		if(latestValue!=""){
			...
			cell2.innerHTML  = '<input type="text" class="form-control" name="pur_qty2[]" id="pur_qty2_'+index+'" step="any" value="0">';
