@include('../layouts.header')
	<body>
                            ...
                            <section class="card">
                                <header class="card-header" style="display: flex;justify-content: space-between;">
                                    ...
                                    <form class="text-end" action="{{ route('create-stock-out-invoice') }}" method="GET">
                                        <button type="submit" class="btn btn-primary"> <i class="fas fa-plus"></i> New Stock Out</button>
                                    </form>
                                </header>
                                <div class="card-body">
                                    <div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="actions">
                                                        ...
                                                        <a href="{{ route('show-stock-out-invoice',$row->Sal_inv_no) }}" class="">
        ...
        <div id="addAttModal" class="zoom-anim-dialog modal-block modal-block-danger mfp-hide">
            <form method="post" action="{{ route('stock_out-att-add') }}" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
                @csrf  
                <section class="card">
                    <header class="card-header">
