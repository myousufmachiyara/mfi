                    ...
                    <section class="card">
						<div class="card-body">
							...
							<div class="d-grid gap-3 d-md-flex justify-content-md-end me-4">
								<button class="btn btn-danger mt-2 mb-2"> <i class="fas fa-print"></i> Print</button>
								<button class="btn btn-primary mt-2 mb-2"> <i class="fas fa-download"></i> Download</button>
								<button class="btn btn-success mt-2 mb-2"> <i class="fas fa-share"></i> Share</button>
							</div>
						</div>
					</section>
				</section>
