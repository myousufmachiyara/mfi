                    ...
                    success: function(result){
                        ...
                        var html = "<tr>";
                            ...
                            $.each(result['lager_much_all'], function(k, v) {
                                ...
                                if (v['entry_of'] === 'Sale') {
                                    html += "<td><a href='/sales/saleinvoice/view/"+v['auto_lager']+"' target='_blank'>" + (v['auto_lager'] ? v['auto_lager'] : "") + "</a></td>";
                                } else if (v['entry_of'] === 'SP') {
                                    html += "<td><a href='/sales2/show/"+v['auto_lager']+"' target='_blank'>" + (v['auto_lager'] ? v['auto_lager'] : "") + "</a></td>";
                                } else if (v['entry_of'] === 'Pur') {
                                    html += "<td><a href='/purchase1/show/"+v['auto_lager']+"' target='_blank'>" + (v['auto_lager'] ? v['auto_lager'] : "") + "</a></td>";
                                }  else if (v['entry_of'] === 'PP') {
                                    html += "<td><a href='/purchase2/show/"+v['auto_lager']+"' target='_blank'>" + (v['auto_lager'] ? v['auto_lager'] : "") + "</a></td>";
                                } else if (v['entry_of'] === 'JV1') {
                                    html += "<td><a href='/vouchers/show/"+v['auto_lager']+"' target='_blank'>" + (v['auto_lager'] ? v['auto_lager'] : "") + "</a></td>";
                                } else if (v['entry_of'] === 'JV2') {
                                    html += "<td><a href='/vouchers2/print/"+v['auto_lager']+"' target='_blank'>" + (v['auto_lager'] ? v['auto_lager'] : "") + "</a></td>";
                                }  else {
                                    html += "<td>" + (v['entry_of'] ? v['entry_of'] : "") + "</td>";
                                }
