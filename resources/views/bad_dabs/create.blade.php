                                    ...
                                    <table class="table table-bordered table-striped mb-0" id="myTable">
                                        ...
                                        <tbody id="bad_dabsTable">
                                            <tr>
                                                ...
                                                <td>
                                                    <select data-plugin-selecttwo class="form-control select-js" id="item_name1" onchange="getItemDetails(1,2)" name="item_name[]" required>
...
function addNewRow() {
    ...
    if (latestValue !== "Select Item") {
        ...
        newRow.append('<td><select data-plugin-selecttwo class="form-control select-js" id="item_name' + index + '" name="item_name[]" onchange="getItemDetails(' + index + ', 2)"><option>Select Item</option>@foreach($items as $key => $row)<option value="{{ $row->it_cod }}">{{ $row->item_name }}</option>@endforeach</select></td>');
