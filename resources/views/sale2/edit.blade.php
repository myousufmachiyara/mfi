											...
											<tbody id="Purchase2Table">
												@foreach ($pur2_item as $pur2_key => $pur2_items)
													<tr>
														...
														<td>
															<select data-plugin-selecttwo class="form-control" autofocus id="item_name{{$pur2_key+1}}" name="item_name[]" onchange="getItemDetails({{$pur2_key+1}},2)" required>
														...
														<td>
															<input type="number" class="form-control" name="pur2_qty2[]" id="pur2_qty2{{$pur2_key+1}}" onchange="CalculateRowWeight({{$pur2_key+1}})" value="{{$pur2_items->Sales_qty2}}" step="any" required>
														</td>
														<td>
