                ...
                <form method="post" id="updateForm" action="{{ route('update-acc') }}" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
                    ...
                    <div class="card-body">
                        <div class="row form-group">
                            ...
                            <div class="col-lg-6 mb-2">
                                <label>Account Group</label>
                                <select data-plugin-selectTwo class="form-control" autofocus name="group_cod" id="update_group_cod">
                                    <option value="">Select Group</option>
                                    @foreach($ac_group as $key => $row)	
                                        <option value="{{$row->group_cod}}">{{$row->group_name}}</option>
                                    @endforeach
                            ...
                            <div class="col-lg-6 mb-2">
                                <label>Account Type</label>
                                <select data-plugin-selectTwo class="form-control" autofocus name="AccountType" required id="update_AccountType">
