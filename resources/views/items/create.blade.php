...
<script>
	...
	function addNewRow(id){
		...
		if(latestValue!="Select Group"){
			...
			cell5.innerHTML  = '<input type="number" class="form-control" name="item_pur_cost[]" required value="0" step=".01">';
			...
			cell7.innerHTML  = '<input type="number" class="form-control" name="item_s_price[]" required value="0" step=".01">';
			...
			cell10.innerHTML  = '<input type="number" class="form-control" name="item_stock_level[]" required value="0" step=".01">';
			cell11.innerHTML = '<input type="number" class="form-control" name="item_l_price[]" required value="0" step=".01">';
