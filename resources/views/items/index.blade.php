                            ...
                            <section class="card">
                                ...
                                <header class="card-header d-block d-lg-none d-md-none" style="display: flex;justify-content: space-between;">
                                    ...
                                    <form action="{{ route('create-item') }}" method="GET">
                                        <button type="button" class="btn btn-primary mt-2 modal-with-zoom-anim ws-normal" href="#createModal"> <i class="fas fa-plus" ></i> Single </button>
                                        <button type="submit" class="btn btn-danger mt-2"> <i class="fas fa-plus"></i>  Multiple </button>
                                    </form>
                                </header>
                                <div class="card-body">
