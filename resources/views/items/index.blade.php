                    ...
                    <div class="card-body">
                        <div class="row form-group">
                            ...
                            <div class="col-lg-6 mb-2">
                                ...
                                <select data-plugin-selecttwo class="form-control select-js" autofocus id="item_group" name ="item_group" required>
                    ...
                    <div class="card-body">
                        <div class="row form-group">
                            ...
                            <div class="col-lg-6 mb-2">
                                ...
                                <select data-plugin-selecttwo class="form-control select-js" autofocus name="item_group[]" required>
                                    <option value="" disabled selected>Select Group</option>
                                    @foreach($itemGroups as $key => $row)	
                                        <option value="{{$row->item_group_cod}}">{{$row->group_name}}</option>
                                    @endforeach
