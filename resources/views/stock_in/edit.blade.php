									...
									<div class="card-body">
										<div class="row form-group mb-2">
											...
											<div class="col-sm-12 col-md-4">
												<label class="col-form-label">Karigar Name</label>
										    ...
										    <tbody id="tstock_inTable">
												@foreach ($tstock_in_items as $tstockin_key => $tstock_items)
													<tr>
														...
														<td>
															<input type="number" id="qty{{$tstockin_key+1}}" onchange="tableTotal()" name="qty[]" placeholder="Qty" value="{{$tstock_items->Sales_qty}}" step="any" required class="form-control">
														</td>
														<td>
                                                            <input type="number" id="weight{{$tstockin_key+1}}" onchange="tableTotal()" name="weight[]" placeholder="Weight" value="{{$tstock_items->weight_pc}}" step="any" required class="form-control">
														</td>
														<td>
