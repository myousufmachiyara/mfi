                    ...
                    <section class="card">
						...
						<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-md-5">
											<div class="bill-data">
												...
												<h4 class="mb-0 h6 mb-1 text-dark font-weight-semibold">
													<span style="color:#17365D">PO#: &nbsp</span>
													<span style="font-weight:400;color:black" class="value"> {{$sales->po}}</span>
												</h4>
												<h4 class="mb-0 h6 mb-1 text-dark font-weight-semibold">
							...
							<div class="d-grid gap-3 d-md-flex justify-content-md-end me-4">
								...
								<a href="{{ route('print-quotation-invoice', $sales->Sal_inv_no) }}" class="btn btn-danger mt-2 mb-2"> <i class="fas fa-print"></i> Print</a>
							</div>
