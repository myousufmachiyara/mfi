				...
				success: function(result){
					$.each(result, function(k,v){
						if(Math.round(v['balance'])>0){
							...
							html+= "<td width='20%'><input type='number' class='form-control text-danger'  value='0' disabled><input type='hidden' name='bill_amount[]' class='form-control' value="+Math.round(v['bill_balance'])+"></td>"
