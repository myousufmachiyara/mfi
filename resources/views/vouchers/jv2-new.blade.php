		...
		$.ajax({
			...
			success: function(result){
				$.each(result, function(k,v){
					...
					html+= "<td width='30%'><input type='number' class='form-control' value="+round(v['b_amt'])+" disabled><input type='hidden' name='balance_amount[]' class='form-control' value="+round(v['b_amt'])+"></td>"
					html+= "<td width='30%'><input type='number' class='form-control' value="+round(v['bill_balance'])+" disabled><input type='hidden' name='bill_amount[]' class='form-control' value="+round(v['bill_balance'])+"></td>"
